...
advanced generation gravitational wave interferometers, aLIGO and Virgo, begin to
record and search gravitational strain data for the signature chirps of
compact binary mergers. Unless astrophysicsists are fundamentally
mistaken about the formation of compact binaries, these observatories, when
operating at design sensitivity, will likely detect between 0.2 and 300
neutron star--black hole \nsbh mergers per year, with the
most likely rate around 10~yr$^{-1}$ \citep{abad2010-rates}.\footnote{
\citet[Tables~2 and~3]{domi2014-merger_rates_part3} provide an updated estimate
of 0.04--5.5 neutron star--black hole \nsbh merger detections by Advanced LIGO
per year, where I have reported lower and upper brackets from their range of
models assuming only inspiral waveforms are used in matched filter searches.
According to the \citet{abad2010-rates} review, the most likely rate for neutron
star--neutron star \nsns mergers is 0.4--400~yr$^{-1}$, and for
black hole--black hole \bhbh mergers is 0.4--1000~yr$^{-1}$.}
