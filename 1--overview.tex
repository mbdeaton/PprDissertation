...
This chain of inquiry is recapped in Chap.~\ref{chap:conclusion}.

In addition to two reference sections on conventions (Sec.~\ref{sec:conventions})
and timescales (Sec.~\ref{sec:timescales}),
