...
\begin{align}
  ...
  p^\alpha\nabla_\alpha f &= 0,
\end{align}
where we have used the four-momentum in the second form. In flat space,
we may write it $p^\alpha:=(\varepsilon/c,p^k)$.
...
modifications in that 1) we use the covariant four-momentum $p_\alpha$ to construct
...
naturally},
and also drawing on Ipser-Thorne (1968)
\todo{fix cites}
