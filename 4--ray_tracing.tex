...
In the 3+1 splitting of Schwarzschild spherical polar coordinates, the metric
takes the form
...
Or in terms of our conventional momentum arguments $(p_t,\alpha,\beta)$
introduced in Sec.?,
\todo{reference this section when you add it}
we have
\begin{equation}
