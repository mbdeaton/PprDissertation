...
points along each dimension requires $10^6$ samplings of $f_\nu$ and
...
$N\sim3\times10^4$ for 10\% accuracy.
...
using code freely available in the open source Gnu Scientific Libary (GSL).
\todo{cite}
To test the integration let us return to the toy models presented in
